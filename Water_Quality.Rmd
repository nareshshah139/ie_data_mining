...
fits1 = lm(E..coli..MF. ~ DO..mg.L.+DO....sat..+EC..uS.cm.+pH+Turb...NTU.+Susp..Solids..mg.L.+NO3..mg.L.as.N.+NO2..mg.L.as.N.+NH3..mg.L.+TKN..mg.L.as.N.+Total.N+PO4.filt...mg.L.as.P.+Total.P..mg.L.as.P., data = training_data)

summary(fits1)

fits2 =  lm(scale(E..coli..MF.) ~  New.Site.Code...post.Jun.2007.+ scale(EC..uS.cm.)+scale(Turb...NTU.^5)+scale(Susp..Solids..mg.L.)+scale(exp(Total.N))+scale(PO4.filt...mg.L.as.P.)+scale(Total.P..mg.L.as.P.^2)+scale(exp(pH)) + scale(Temp...C.), data = training_data)

summary(fits2)

fits3 =  lm(pH ~  New.Site.Code...post.Jun.2007.+ scale(EC..uS.cm.^2)+scale(Turb...NTU.^2)+scale(Susp..Solids..mg.L.)+scale(Total.N)+scale(Total.P..mg.L.as.P.), data = training_data)

summary(fits3)

fits4 = lm(Total.N ~  scale(training_data$NO3..mg.L.as.N.)+scale(training_data$NO2..mg.L.as.N.)+scale(training_data$NH3..mg.L.)+scale(training_data$TKN..mg.L.as.N.), data = training_data)
